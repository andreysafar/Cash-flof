...
private val LightColors = lightColorScheme(
    ...
    tertiaryContainer = Color(0xFFCDE7F2),
    onTertiaryContainer = Color(0xFF0C2A36),
...
private val DarkColors = darkColorScheme(
    ...
    onTertiary = Color(0xFF06303D),
    tertiaryContainer = Color(0xFF114B5C),
    onTertiaryContainer = Color(0xFFCDE7F2),
